...
(
  ...
  LANQIN_ADDR=127.0.0.1:18084 \
  LANQIN_ADMIN_EMAIL=admin@lanqin.local \
  LANQIN_ADMIN_PASSWORD=admin \
  LANQIN_RESET_ADMIN_PASSWORD_ON_START=true \
  LANQIN_PUBLIC_BASE_URL=http://127.0.0.1:5190 \
...
echo "本地预览地址：http://127.0.0.1:5190/login"
VITE_API_TARGET=http://127.0.0.1:18084 pnpm --dir "$ROOT_DIR/apps/web" dev --host 127.0.0.1
