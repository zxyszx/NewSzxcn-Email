...
export type MailLabel = { id: string; mailboxId?: string; name: string; color: string; messageCount?: number; unreadCount?: number }
...
export type ForwardingSettings = { verifiedEmails: ForwardingVerifiedEmail[]; accountTargetEmail: string; accountTargetEmails?: string[]; mailboxRules: MailboxForwardingRule[]; pendingBindings?: ForwardingPendingBinding[]; mailboxSummaries?: ForwardingMailboxSummary[] }
